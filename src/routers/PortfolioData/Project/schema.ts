...
export const get_project_schema = zod.object({
    portfolio_data_id:zod.string({required_error:'portfolio_data_id is missing in json',invalid_type_error:'portfolio_data_id need to be a string'}).regex(/^[a-fA-F0-9]{24}$/,'website_design_id need to be valid ObjectID'),
